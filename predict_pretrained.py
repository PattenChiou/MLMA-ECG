...
if __name__ == '__main__':
    ...
    predictions = predict_labels(ecg_leads, fs, ecg_names, use_pretrained=True, device=torch.device("cuda:7" if torch.cuda.is_available() else "cpu"), is_binary_classifier=False)
